...
public class Craps {
    ...
    // CASO NÃƒO HOUVER GANHADOR O STATUS SERA CONTINUE E CHAMARA O METODO ROLLDADO
    ...
    public void play() {
        ...
        switch (somaDoDado) {
            ...
            case DOZE:
                ...
                // POR DEFAULT  SERA O STATUS DE CONTINUAÃ‡ÃƒO
            default:
        ...
        while (gameStatus == Status.CONTINUE) {
            somaDoDado=rollDado();
                /// CASO TENHA SIDO A APROVAÃ‡ÃƒO DE CONTINUAR  AQUI SERÃ� DEFINIDA A VITORIA OU DERROTA DO JOGADOR
